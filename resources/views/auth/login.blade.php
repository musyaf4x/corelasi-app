<x-guest-layout>
    <div class="w-full max-w-[420px] px-6 py-4 flex flex-col items-center mt-8 sm:mt-0">
        ...
        <div class="w-full bg-white border border-[#E2E8F0] shadow-sm rounded-xl p-6 mb-8">
            ...
            @if ($errors->any())
                <div
                    class="bg-[#FEF2F2] border border-[#FECACA] text-[#B91C1C] px-4 py-3 rounded-lg mb-6 flex items-start gap-3 relative">
            ...
            <form method="POST" action="{{ route('login') }}">
                ...
                <div class="mb-5">
                    ...
                    @if($errors->any())
                        <div class="mt-2 text-[#EF4444] text-xs flex items-start gap-1">
                            ...
                            <span><span class="font-semibold">Email tidak terdaftar.</span><br><span
                                    class="text-[#94A3B8]">Silahkan cek kembali atau hubungi admin</span></span>
                        </div>
                    @endif
                </div>
                ...
                <div class="mb-5">
                    <label for="password"
                        class="block text-xs font-semibold text-[#64748B] tracking-wider mb-2 uppercase">Kata
                        Sandi</label>
                    <div class="relative">
                        <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                            <svg class="h-5 w-5 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"
