<x-app-layout>
    ...
    <aside class="w-64 bg-white border-r border-[#E2E8F0] min-h-screen flex flex-col fixed left-0 top-0 z-20 shadow-sm">
        ...
        <nav class="flex-1 px-4 py-4 space-y-1 overflow-y-auto no-scrollbar">
            <!-- Active Menu -->
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 bg-green-50 text-[#2D7336] rounded-md font-medium text-sm">
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-[#64748B] hover:bg-gray-50 hover:text-[#1E293B] rounded-md font-medium text-sm transition-colors">
                <svg class="w-5 h-5 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                Presensi Sesi Aktif
            </a>
            
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-[#64748B] hover:bg-gray-50 hover:text-[#1E293B] rounded-md font-medium text-sm transition-colors">
                <svg class="w-5 h-5 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                Verifikasi Absensi
            </a>
            ...
            <a href="#" class="flex items-center gap-3 px-3 py-2.5 text-[#64748B] hover:bg-gray-50 hover:text-[#1E293B] rounded-md font-medium text-sm transition-colors">
                <svg class="w-5 h-5 flex-shrink-0 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16v1a3 3 0 003 3h10a3 3 0 003-3v-1m-4-8l-4-4m0 0L8 8m4-4v12"></path></svg>
                Pengumpulan Tugas
            </a>
    ...
    <div class="ml-64 flex-1 flex flex-col min-h-screen relative w-full">
        ...
        <header class="h-16 border-b border-[#E2E8F0] bg-[#F8FAFC]/80 backdrop-blur top-0 z-10 flex items-center justify-between px-8 absolute w-full">
            <!-- Left: Semester Info -->
            <div>
            ...
            <div class="flex items-center gap-6">
                ...
                <div class="flex items-center gap-3 cursor-pointer">
                    ...
                    <div class="w-9 h-9 rounded-full bg-gray-200 border border-gray-300 overflow-hidden">
                        <img src="https://ui-avatars.com/api/?name=Admin&background=1E293B&color=fff" alt="Admin" class="w-full h-full object-cover">
                    </div>
                </div>
            </div>
        </header>
        ...
        <main class="flex-1 p-8 pt-24 flex gap-8">
            ...
            <div class="flex-1 flex flex-col min-w-0">
                ...
                <div class="mb-8">
                    ...
                    <p class="text-base text-[#64748B]">Pantau integritas operasional dan aktivitas akademik hari ini.</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-5 mb-10">
                    ...
                    <div class="bg-white rounded-2xl border border-[#E2E8F0] p-5 shadow-[0_1px_3px_0_rgb(0,0,0,0.02)]">
                        <div class="flex justify-between items-start mb-4">
                            <div class="w-10 h-10 rounded-xl bg-green-50 flex items-center justify-center text-[#2D7336]">
                                <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14.752 11.168l-3.197-2.132A1 1 0 0010 9.87v4.263a1 1 0 001.555.832l3.197-2.132a1 1 0 000-1.664z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M21 12a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                            </div>
                            <span class="bg-green-100 text-[#2D7336] text-[11px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">LIVE</span>
                        </div>
                        ...
                        <div class="flex items-start gap-1 text-xs text-[#64748B]">
                            <svg class="w-4 h-4 text-green-500 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13 7h8m0 0v8m0-8l-8 8-4-4-6 6"></path></svg>
                    ...
                    <div class="bg-white rounded-2xl border border-[#E2E8F0] p-5 shadow-[0_1px_3px_0_rgb(0,0,0,0.02)]">
                        <div class="flex justify-between items-start mb-4">
                            <div class="w-10 h-10 rounded-xl bg-gray-50 flex items-center justify-center text-[#64748B]">
                    ...
                    <div class="bg-white rounded-2xl border border-[#E2E8F0] p-5 shadow-[0_1px_3px_0_rgb(0,0,0,0.02)]">
                        <div class="flex justify-between items-start mb-4">
                            ...
                            <span class="bg-red-100 text-red-600 text-[11px] font-bold px-2 py-0.5 rounded-full uppercase tracking-wider">PRIORITY</span>
                        </div>
                ...
                <div class="mb-10">
                    <div class="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p class="text-sm text-[#64748B] mt-0.5">Tugas operasional yang memerlukan tindakan segera.</p>
                        </div>
                        <a href="#" class="text-sm font-semibold text-[#2D7336] hover:text-[#1E5725] flex items-center gap-1 transition-colors">
                            Lihat Semua 
                    ...
                    <div class="flex flex-col gap-3">
                        <!-- Alert Item 1 -->
                        <div class="bg-white border border-[#E2E8F0] shadow-sm rounded-xl p-4 flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-lg bg-red-100/80 flex items-center justify-center text-red-500 flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 9v2m0 4h.01m-6.938 4h13.856c1.54 0 2.502-1.667 1.732-3L13.732 4c-.77-1.333-2.694-1.333-3.464 0L3.34 16c-.77 1.333.192 3 1.732 3z"></path></svg>
                                </div>
                                <div>
                                    <h4 class="font-bold text-[#1E293B] text-sm md:text-base">Jurnal Pertemuan Tidak Lengkap</h4>
                                    <p class="text-xs text-[#64748B] mt-0.5">Kelas XII IPA 1 - Matematika (Bpk. Ahmad)</p>
                                </div>
                            </div>
                            <button class="bg-[#3D8545] hover:bg-[#2D7336] text-white px-5 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm">
                                Selesaikan
                            </button>
                        </div>
                        ...
                        <div class="bg-white border border-[#E2E8F0] shadow-sm rounded-xl p-4 flex items-center justify-between">
                            <div class="flex items-center gap-4">
                                <div class="w-10 h-10 rounded-lg bg-gray-100 flex items-center justify-center text-[#64748B] flex-shrink-0">
                                    <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                                </div>
                                <div>
                                    <h4 class="font-bold text-[#1E293B] text-sm md:text-base">Tenggat Pengumpulan Tugas Terlampaui</h4>
                                    <p class="text-xs text-[#64748B] mt-0.5">Kimia Dasar - 12 Siswa belum mengumpulkan</p>
                                </div>
                            </div>
                            <button class="bg-[#F1F5F9] hover:bg-[#E2E8F0] text-[#475569] px-5 py-2 rounded-lg text-sm font-semibold transition-colors shadow-sm">
                                Review
                            </button>
                        </div>
                    </div>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                        <div class="bg-white border border-[#E2E8F0] rounded-xl p-6 flex flex-col items-center justify-center text-center cursor-pointer hover:border-[#2D7336] hover:shadow-md transition-all group">
                            <svg class="w-8 h-8 text-[#64748B] group-hover:text-[#2D7336] mb-3 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 4.354a4 4 0 110 5.292M15 21H3v-1a6 6 0 0112 0v1zm0 0h6v-1a6 6 0 00-9-5.197M13 7a4 4 0 11-8 0 4 4 0 018 0z"></path></svg>
            ...
            <div class="w-[340px] flex-shrink-0 flex flex-col gap-6 hidden xl:block">
                ...
                <div class="bg-white border border-[#E2E8F0] shadow-sm rounded-2xl p-6">
                    ...
                    <div class="border-t border-[#E2E8F0] pt-5">
                        <h4 class="text-[11px] font-bold tracking-wider text-[#94A3B8] uppercase mb-3">Status Semester</h4>
                        <div class="bg-[#F8FAFC] rounded-lg p-3 flex justify-between items-center mb-2 text-sm border border-[#F1F5F9]">
                        ...
                        <div class="bg-[#F0FDF4] rounded-lg p-3 flex justify-between items-center text-sm border border-green-100">
                            <span class="text-[#64748B] flex items-center gap-2">
                ...
                <div class="bg-white border border-[#E2E8F0] shadow-sm rounded-2xl p-6 relative">
                    ...
                    <div class="relative border-l border-gray-200 ml-3 space-y-6">
                        ...
                        <div class="relative pl-6">
                            <span class="absolute -left-3.5 top-0.5 bg-green-600 rounded-full w-7 h-7 flex items-center justify-center border-4 border-white shadow-sm text-white">
                            ...
                            <p class="text-[13px] text-[#64748B] leading-relaxed mb-1">Ibu Ratna mengunggah 'Modul Termodinamika' untuk Kelas XI IPA 2.</p>
                            <span class="text-[11px] text-[#94A3B8] font-medium block">10 menit yang lalu</span>
                        </div>

                        <!-- Activity 2 -->
                        <div class="relative pl-6">
                            <span class="absolute -left-3.5 top-0.5 bg-[#475569] rounded-full w-7 h-7 flex items-center justify-center border-4 border-white shadow-sm text-white">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7"></path></svg>
                            </span>
                            <h4 class="font-bold text-[#1E293B] text-sm leading-tight mb-1">Absensi Terverifikasi</h4>
                            <p class="text-[13px] text-[#64748B] leading-relaxed mb-1">Sesi Bahasa Inggris XII IPS 1 telah diverifikasi otomatis oleh sistem.</p>
                            <span class="text-[11px] text-[#94A3B8] font-medium block">25 menit yang lalu</span>
                        </div>

                        <!-- Activity 3 -->
                        <div class="relative pl-6">
                            <span class="absolute -left-3.5 top-0.5 bg-gray-400 rounded-full w-7 h-7 flex items-center justify-center border-4 border-white shadow-sm text-white">
                                <svg class="w-3 h-3" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z"></path></svg>
                            </span>
                            <h4 class="font-bold text-[#1E293B] text-sm leading-tight mb-1">Nilai Baru Dipublikasi</h4>
                            <p class="text-[13px] text-[#64748B] leading-relaxed mb-1">Hasil kuis 'Sejarah Kebudayaan Islam' telah dirilis oleh Bpk. Fauzi.</p>
                            <span class="text-[11px] text-[#94A3B8] font-medium block">1 jam yang lalu</span>
                        </div>
                    </div>

                    <div class="mt-6">
                        <button class="w-full bg-[#F8FAFC] hover:bg-[#F1F5F9] border border-[#E2E8F0] text-[#64748B] font-semibold py-2.5 rounded-lg text-sm transition-colors">
